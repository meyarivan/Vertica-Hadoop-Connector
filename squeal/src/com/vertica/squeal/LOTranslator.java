...
public class LOTranslator extends LOVisitor {
  ...
  /**
   * @param lOp the logical operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param eOp the logical expression operator that has to be visited
   * @throws VisitorException
   */
...
binOp.getRhsOperand().visit(this);
  ...
  /**
   * @param uniOp the logical unary operator that has to be visited
   * @throws VisitorException
   */
...
uniOp.getOperand().visit(this);
  ...
  /**
   * @param loj the logical join operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param forEach the logical foreach operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param s the logical sort operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param filter the logical filter operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param split the logical split operator that has to be visited
   * @throws VisitorException
   */
...
logicalOp.visit(this);
  ...
  /**
   * @param g the logical generate operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param cast the logical cast operator that has to be visited
   * @throws VisitorException
   */
  ...
  /**
   * @param regexp the logical regexp operator that has to be visited
