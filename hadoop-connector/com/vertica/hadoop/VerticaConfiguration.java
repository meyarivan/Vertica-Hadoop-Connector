...
public class VerticaConfiguration {
   ...
   * @param port      Vertica database port
   */
   ...
   * @param password  Vertica database password
   * @param port      Vertica database port
   * @param level     JDBC logging level
   */
  public static void configureVertica(Configuration conf, String[] hostnames,
   ...
   * @param port      Vertica database port
   * @param level     JDBC logging level
   * @param logpath   JDBC log path - location of logs to be written, default is current directory
   */
  public static void configureVertica(Configuration conf, String[] hostnames,
   ...
   * @param password         for the source Vertica database
   * @param port             for the source Vertica database
   * @param level            JDBC logging level
   * @param logpath          JDBC deug logging  - location of logs to be written, default is current directory
   ...
   * @param output_port      for the target Vertica database
   */
  public static void configureVertica(Configuration conf, String[] hostnames,
                                      String database, String port, String username, String password, String level, String logpath,
